  ...
  const re = [
    function (e) {
      ...
      function n(e, t) {
        ...
        const i = a.renderSlide
          ...
          : d(`<div className="${s.params.slideClass}" data-swiper-slide-index="${t}">${e}</div>`)
        return (
    ...
    function (e) {
      ...
      function T() {
        ...
        0 === r.length && ((r = d(`<div className="${t.params.scrollbar.dragClass}"></div>`)), i.append(r)),
    ...
    function (e) {
      ...
      a('beforeInit', () => {
        i = d(`<span className="${t.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`)
      }),
        a('afterInit', () => {
    ...
    function (e) {
      ...
      const i = (e, t, s) => {
        ...
        0 === a.length && ((a = d(`<div className="swiper-slide-shadow-${s ? 'left' : 'top'}"></div>`)), e.append(a)),
          0 === i.length &&
            ((i = d(`<div className="swiper-slide-shadow-${s ? 'right' : 'bottom'}"></div>`)), e.append(i)),
          ...
          p.shadow &&
            (u
              ? ((m = s.find('.swiper-cube-shadow')),
                0 === m.length && ((m = d('<div className="swiper-cube-shadow"></div>')), s.append(m)),
                m.css({ height: `${r}px` }))
              : ((m = e.find('.swiper-cube-shadow')),
                0 === m.length && ((m = d('<div className="swiper-cube-shadow"></div>')), e.append(m))))
          for (let e = 0; e < a.length; e += 1) {
            const t = a.eq(e)
            let s = e
