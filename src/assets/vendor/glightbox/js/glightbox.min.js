!(function (e, t) {
  ...
  function F(e, t, i, n) {
    ...
    h(l, 'gvideo-container'), r.insertBefore(m('<div className="gvideo-wrapper"></div>'), r.firstChild)
      ...
      S(this.settings.plyr.js, 'Plyr', function () {
        if (
          ...
          ;(l += 'style="background:#000; max-width: '.concat(t.width, ';" ')),
            ...
            (l += 'playsinline '),
            (l += 'controls '),
            (l += 'className="gvideo-local">'),
            (l += '<source src="'.concat(c, '">')),
            (g = m((l += '</video>')))
        }
        var r =
          g ||
          m('<div id="'.concat(o, '" data-plyr-provider="').concat(u, '" data-plyr-embed-id="').concat(c, '"></div>'))
  ...
  function G(e, t, i, n) {
    ...
    if (d && (C(d) && (s = m('<div className="ginlined-content">'.concat(d, '</div>'))), k(d))) {
        ...
        n(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return l ? ((n = null), o + '... <a href="#" className="desc-more">' + i + '</a>') : o
            },
          },
          {
            ...
            value: function () {
              ...
              if ((e = e || this.activeSlide) && !c(e, 'zoomed')) {
                ...
                if ((l <= 768 ? h(document.body, 'glightbox-mobile') : d(document.body, 'glightbox-mobile'), i || n)) {
                  var r = !1
                  if (
                    (s && (c(s, 'description-bottom') || c(s, 'description-top')) && !c(s, 'gabsolute') && (r = !0), n)
                  )
