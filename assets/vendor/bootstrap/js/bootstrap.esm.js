...
class Dropdown extends BaseComponent {
  constructor(element, config) {
    ...
    this._menu =
      SelectorEngine.next(this._element, SELECTOR_MENU)[0] || SelectorEngine.prev(this._element, SELECTOR_MENU)[0]
  ...
  static dataApiKeydownHandler(event) {
    ...
    const getToggleButton = this.matches(SELECTOR_DATA_TOGGLE$3)
      ? this
      : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0] || SelectorEngine.next(this, SELECTOR_DATA_TOGGLE$3)[0]
